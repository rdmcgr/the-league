...
function renderFutures(data, keeperTeams) {
  ...
  description.textContent = isLocalPreview
    ...
    : data.marketStatus === 'open'
      ? 'Let’s see who we collectively think has the best team before the season starts. Check out the market data below (click the header for more info) or simply scroll down to place your bet! Wagers are private until the market closes on Sunday, 9/13.'
